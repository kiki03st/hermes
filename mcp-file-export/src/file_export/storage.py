...
# Windows에서 실제 금지된 문자만 걸러낸다 — 예전엔 [^A-Za-z0-9._-] 밖은 전부 "_"로
# 바꿔서 한글 등 비ASCII 파일명이 "________.md"처럼 통째로 깨졌다(실측 버그,
# 2026-08-29 — upload-server/storage.py와 같은 버그, 같은 수정).
